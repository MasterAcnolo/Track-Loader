            ...
            <div class="account-grid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p style="color: var(--text-secondary); font-size: 0.875rem; margin-bottom: 1rem;">
                            Vous êtes connecté en tant que <strong><?php echo htmlspecialchars($_SESSION['user']['email']); ?></strong>.
                        </p>
                ...
                <div class="card card-danger">
                    ...
                    <div class="card-body">
                        ...
                        <form action="TODO" method="DELETE" onsubmit="return confirm('Êtes-vous vraiment sûr de vouloir supprimer votre compte ? Cette action est irréversible.');">
